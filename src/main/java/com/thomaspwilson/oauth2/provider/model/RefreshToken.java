...
/**
 * The RefreshToken provides the client with a means to refresh an access token
...
public interface RefreshToken extends Token {
    /**
     * Retrieves the identifier of the access token for which the refresh token
     * was issued.
     * @return The access token id
     */
    String getSourceAccessTokenId();
}